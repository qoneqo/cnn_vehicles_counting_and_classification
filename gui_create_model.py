...
class GUICreateModel:
    ...
    def gui_frame_inp_12(self):
        self.frame_inp_12 = tk.LabelFrame(
            self.frame_inp_1, text='Folder Output')
    ...
    def gui_entry_pilih_folder_output(self):
        self.entry_pilih_folder_output = entry_pilih_folder_output = tk.Entry(
            self.frame_inp_12)
        ...
        entry_pilih_folder_output.bind(
            '<KeyRelease>', self.ev_entry_pilih_folder_output)
    ...
    def gui_btn_pilih_folder_output(self):
        self.btn_pilih_folder_output = btn_pilih_folder_output = tk.Button(
            self.frame_inp_12, text='Browse', command=self.ev_btn_pilih_folder_output)
    ...
    def ev_btn_pilih_folder_output(self):
        file_name = tk.filedialog.askdirectory(
            parent=self.frame_inp_12, title='Plih folder output', initialdir='saved_model/')
    ...
    def gui_frame_inp_21(self):
        ...
        self.frame_inp_21 = tk.LabelFrame(
            self.frame_inp_2, text='Folder Data Latih')
    ...
    def gui_entry_pilih_folder_latih(self):
        self.entry_pilih_folder_latih = entry_pilih_folder_latih = tk.Entry(
            self.frame_inp_21)
        ...
        entry_pilih_folder_latih.bind(
            '<KeyRelease>', self.ev_entry_pilih_folder_latih)
    ...
    def gui_btn_pilih_folder_latih(self):
        self.btn_pilih_folder_latih = btn_pilih_folder_latih = tk.Button(
            self.frame_inp_21, text='Browse', command=self.ev_btn_pilih_folder_latih)
        btn_pilih_folder_latih.pack(side=tk.LEFT, padx=(0, 10))

    def ev_btn_pilih_folder_latih(self):
        file_name = tk.filedialog.askdirectory(
            parent=self.frame_inp_21, title='Plih folder data latih', initialdir='dataset/train/')
    ...
    def gui_frame_inp_22(self):
        self.frame_inp_22 = tk.LabelFrame(
            self.frame_inp_2, text='Folder Data Uji')
    ...
    def gui_entry_pilih_folder_uji(self):
        self.entry_pilih_folder_uji = entry_pilih_folder_uji = tk.Entry(
            self.frame_inp_22)
        ...
        entry_pilih_folder_uji.bind(
            '<KeyRelease>', self.ev_entry_pilih_folder_uji)
    ...
    def gui_btn_pilih_folder_uji(self):
        self.btn_pilih_folder_uji = btn_pilih_folder_uji = tk.Button(
            self.frame_inp_22, text='Browse', command=self.ev_btn_pilih_folder_uji)
        btn_pilih_folder_uji.pack(side=tk.LEFT, padx=(0, 10))

    def ev_btn_pilih_folder_uji(self):
        file_name = tk.filedialog.askdirectory(
            parent=self.frame_inp_22, title='Plih folder data uji', initialdir='dataset/test/')
    ...
    def gui_frame_inp_31(self):
        self.frame_inp_3 = tk.LabelFrame(
            self.main_frame, text='Input Jumlah & Jenis Kendaraan')
        self.frame_inp_3 = tk.LabelFrame(
            self.main_frame, text='Input Jenis Kendaraan')
    ...
    def gui_jumlah_kendaraan(self):
        ...
        self.label_warn_jumlah_kendaraan = label = tk.Label(
            self.frame_inp_31, text="Minimal Jumlah Kendaraan = 2 dan Maksimal Jumlah Kendaraan = 10 !", fg="yellow")
        label.pack(side=tk.LEFT, padx=10)
    ...
    def gui_entry_jumlah_kendaraan(self):
        self.entry_jumlah_kendaraan = entry_jumlah_kendaraan = tk.Entry(
            self.frame_inp_31)
        ...
        entry_jumlah_kendaraan.bind(
            '<KeyRelease>', self.ev_entry_jumlah_kendaraan)

    def ev_entry_jumlah_kendaraan(self, event):
        self.jumlah_kendaraan = self.entry_jumlah_kendaraan.get() or 2
    ...
    def gui_label_jenis_kendaraan(self, len=0):
        ...
        label = tk.Label(
            self.frame_inp_4x[len_frame], text="Input Jenis Kendaraan "+str(len+1)+": ")
        label.pack(side=tk.LEFT, padx=10)
    ...
    def gui_entry_jenis_kendaraan(self, len=0):
        ...
        self.entry_jenis_kendaraan[len] = tk.Entry(
            self.frame_inp_4x[len_frame])
        self.entry_jenis_kendaraan[len].pack(side=tk.LEFT, padx=10)

        self.entry_jenis_kendaraan[len].insert(
            0, str(self.jenis_kendaraan[len]))
        self.entry_jenis_kendaraan[len].bind(
            '<KeyRelease>', self.ev_entry_jenis_kendaraan)
...
# FRAME EPOCHS
    ...
    def gui_button(self):
        ...
        self.button_1 = button_1 = tk.Button(
            self.frame_5, text='Latih Model', width=25, command=self.train)
        button_1.pack(side=tk.LEFT, padx=(0, 10))

        self.button_2 = button_2 = tk.Button(
            self.frame_5, text='Uji Model', width=25, command=self.test)
    ...
    def gui_label_finish(self):
        ...
        self.label_finish = label_finish = tk.Label(
            self.frame_6, text='', font=("Arial", 12))
        label_finish.pack(side=tk.LEFT, padx=10)

    def train(self):
        cnn = TrainNTestCNN(model_name=self.nama_model, model_folder=self.pilih_folder_output, train_folder=self.pilih_folder_latih,
                            test_folder=self.pilih_folder_uji, jumlah_kendaraan=int(self.jumlah_kendaraan), nama_kendaraan=self.jenis_kendaraan)
